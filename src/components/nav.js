...
const Nav = () => (
  <nav className={styles.nav}>
      ...
      <a href="https://www.jameda.de/schulzendorf/aerzte/innere-allgemeinmediziner/peggy-von-niederhaeusern/uebersicht/81191615_1/?utm_source=OTB-Button&utm_campaign=Kunden-Homepages" className={`${styles.desktop} ${styles.button}`} activeClassName={styles.active}>Termin buchen</a>
      ...
      <a href="tel:03376248550/termine" className={styles.mobile}>
       ...
       <span>Kontakt</span></a>
      <a href="https://www.jameda.de/schulzendorf/aerzte/innere-allgemeinmediziner/peggy-von-niederhaeusern/uebersicht/81191615_1/?utm_source=OTB-Button&utm_campaign=Kunden-Homepages" className={styles.mobile} activeClassName={styles.active}>
